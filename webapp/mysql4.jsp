...
<body>
	...
	{     
		...
		LogManager lmng = new LogManager("F:\\data4\\", true);  
		
		if (stmt_type==1)
		{ 
			String pbase_sql="select * from posts where postid>=17100115 and postid<20400115 and  deltag=0 "
				...
				for(int i=0;i<=3000;i++){
					...
					conn.commit();
					System.out.println("正在执行mysql4第"+i*batch+"条记录！");
